    ...
    <?php else: ?>
        <div class="nsl-admin-getting-started">
            ...
            <ol>
                ...
                <li><?php printf(__('Fill "<b>Allowed Origins</b>" with the url of your homepage, probably: <b>%s</b>', 'nextend-facebook-connect'), $provider->getAdmin()
                                                                                                                                                              ->getSiteUrlWithoutPath()); ?></li>
                <li><?php
