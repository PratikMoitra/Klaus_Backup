...
class NextendSocialPROProviderApple extends NextendSocialProviderOAuth {
    ...
    protected function getCurrentUserInfo() {
        ...
        $result = json_decode(base64_decode(str_replace(['-', '_'], ['+', '/'], $token_parts[1])), true);
    ...
    public function getAuthUserData($key) {
        switch ($key) {
            ...
            case 'email':
                ...
                $email = '';
                if (!empty($this->authUserData['email']) && $this->getProviderEmailVerificationStatus()) {
    ...
    public function getProviderEmailVerificationStatus() {
         ...
         * The 'email_verified' field value is either a string or boolean type
         * We should check this and return a boolean type
         */
        $email_verified = $this->authUserData['email_verified'];
